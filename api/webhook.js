        ...
        try {
          ...
          switch (event.type) {
            ...
            case 'follow':
              ...
              await replyTokenMessage(replyToken, 'ようこそ大学の時間割へ');
              break;
 ...
 * @param {string} displayName - LINEのディスプレイネーム
 */
